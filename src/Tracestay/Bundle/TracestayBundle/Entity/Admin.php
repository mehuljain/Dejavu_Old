...
class Admin
{
     ...
     * @var string
     *
     * @ORM\Column(name="tAdminDesignation", type="string", length=255, nullable=true)
     */
    private $tadmindesignation;

    /**
     * @var string
     *
     * @ORM\Column(name="nPermissionLevel", type="string", length=255, nullable=true)
     */
    private $npermissionlevel;
