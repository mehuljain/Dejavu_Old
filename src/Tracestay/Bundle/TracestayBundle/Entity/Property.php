 ...
 * @ORM\Table(name="property", indexes={@ORM\Index(name="fk_property_client1_idx", columns={"clientId"}), @ORM\Index(name="fk_property_propertyDetail1_idx", columns={"propertyDetail_id"}), @ORM\Index(name="fk_property_ownershipStatusRecord1_idx", columns={"ownershipStatusRecord_id"})}, uniqueConstraints={@ORM\UniqueConstraint(name="university_id_UNIQUE", columns={"universityId"})})
 */
class Property
{
    /**
