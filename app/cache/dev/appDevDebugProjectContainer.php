...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'trace.bundle.client.form.type' => 'getTrace_Bundle_Client_Form_TypeService',
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'mydb', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/Tracestay/Bundle/TracestayBundle/Entity'))), 'Tracestay\\Bundle\\TracestayBundle\\Entity');
        ...
        $b->setEntityNamespaces(array('TracestayBundle' => 'Tracestay\\Bundle\\TracestayBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_b1f424de193d65893e0a972ace7b147d79fcf6fc7fb7babd994870f1d0af7fe3');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('Tracestay\\Bundle\\TracestayBundle\\Entity\\Client');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Tracestay\\Bundle\\TracestayBundle\\Entity\\Client');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Tracestay\\Bundle\\TracestayBundle\\Entity\\Client');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('Tracestay\\Bundle\\TracestayBundle\\Entity\\Client');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Tracestay\\Bundle\\TracestayBundle\\Entity\\Client');
    }
    ...
    /**
     * Gets the 'trace.bundle.client.form.type' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Trace\Bundle\TraceBundle\Form\ClientType A Trace\Bundle\TraceBundle\Form\ClientType instance.
     */
    protected function getTrace_Bundle_Client_Form_TypeService()
    {
        return $this->services['trace.bundle.client.form.type'] = new \Trace\Bundle\TraceBundle\Form\ClientType('Tracestay\\Bundle\\TracestayBundle\\Entity\\Client');
    }
    ...
    protected function getTranslator_DefaultService()
    {
        ...
        $instance->addResource('xlf', ($this->targetDirs[3].'/src/Tracestay/Bundle/TracestayBundle/Resources/translations/messages.fr.xlf'), 'fr', 'messages');
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Tracestay/Bundle/TracestayBundle/Resources/views'), 'Tracestay');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('80804e563ba2bef85f1a59025a12e036ce31caf7');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'TracestayBundle' => 'Tracestay\\Bundle\\TracestayBundle\\TracestayBundle',
            ...
            'locale' => 'en',
            'secret' => '80804e563ba2bef85f1a59025a12e036ce31caf7',
            ...
            'kernel.secret' => '80804e563ba2bef85f1a59025a12e036ce31caf7',
            ...
            'fos_user.model.user.class' => 'Tracestay\\Bundle\\TracestayBundle\\Entity\\Client',
